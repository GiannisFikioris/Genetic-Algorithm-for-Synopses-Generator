...
public class critical_point extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** UNIX epoch timestamp (i.e., milliseconds elapsed since 1970-01-01 00:00:00.000) assigned at the admission point to the module (transaction time used internally by the application). Optional. */
  @Deprecated public long ingestion_timestamp;
  /** Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required. */
  @Deprecated public double heading_diff;
  /** Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required. */
  @Deprecated public double percental_speed_change;
   ...
   * @param ingestion_timestamp UNIX epoch timestamp (i.e., milliseconds elapsed since 1970-01-01 00:00:00.000) assigned at the admission point to the module (transaction time used internally by the application). Optional.
   * @param heading_diff Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required.
   * @param percental_speed_change Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required.
   */
  public critical_point(java.lang.Long timestamp, java.lang.CharSequence id, java.lang.Double longitude, java.lang.Double latitude, eu.datacron.synopses.maritime.critical_point_annotation annotation, java.lang.Double distance, java.lang.Double speed, java.lang.Double heading, java.lang.Long time_elapsed, java.lang.CharSequence msg_error_flag, java.lang.Long ingestion_timestamp, java.lang.Double heading_diff, java.lang.Double percental_speed_change) {
    ...
    this.heading_diff = heading_diff;
    this.percental_speed_change = percental_speed_change;
  }
  ...
  public java.lang.Object get(int field$) {
    ...
    case 11: return heading_diff;
    case 12: return percental_speed_change;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 11: heading_diff = (java.lang.Double)value$; break;
    case 12: percental_speed_change = (java.lang.Double)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return UNIX epoch timestamp (i.e., milliseconds elapsed since 1970-01-01 00:00:00.000) assigned at the admission point to the module (transaction time used internally by the application). Optional.
   */
  ...
  /**
   * Gets the value of the 'heading_diff' field.
   * @return Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required.
   */
  public java.lang.Double getHeadingDiff() {
    return heading_diff;
  }

  /**
   * Sets the value of the 'heading_diff' field.
   * Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required.
   * @param value the value to set.
   */
  public void setHeadingDiff(java.lang.Double value) {
    this.heading_diff = value;
  }

  /**
   * Gets the value of the 'percental_speed_change' field.
   * @return Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required.
   */
  public java.lang.Double getPercentalSpeedChange() {
    return percental_speed_change;
  }

  /**
   * Sets the value of the 'percental_speed_change' field.
   * Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required.
   * @param value the value to set.
   */
  public void setPercentalSpeedChange(java.lang.Double value) {
    this.percental_speed_change = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<critical_point>
    ...
    /** Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required. */
    private double percental_speed_change;
    ...
    private Builder(eu.datacron.synopses.maritime.critical_point.Builder other) {
      ...
      if (isValidValue(fields()[11], other.heading_diff)) {
        this.heading_diff = data().deepCopy(fields()[11].schema(), other.heading_diff);
        fieldSetFlags()[11] = true;
      }
      if (isValidValue(fields()[12], other.percental_speed_change)) {
        this.percental_speed_change = data().deepCopy(fields()[12].schema(), other.percental_speed_change);
    ...
    /**
      * Sets the value of the 'heading_diff' field.
      * Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required.
      * @param value The value of 'heading_diff'.
      * @return This builder.
      */
    public eu.datacron.synopses.maritime.critical_point.Builder setHeadingDiff(double value) {
    ...
    /**
      * Checks whether the 'heading_diff' field has been set.
      * Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required.
      * @return True if the 'heading_diff' field has been set, false otherwise.
      */
    public boolean hasHeadingDiff() {
      return fieldSetFlags()[11];
    }


    /**
      * Clears the value of the 'heading_diff' field.
      * Instantaneous difference in heading over ground and mean heading (used for turning points). A value of 0 means that the vessel was stopped. Default value is -1. Required.
      * @return This builder.
      */
    public eu.datacron.synopses.maritime.critical_point.Builder clearHeadingDiff() {
    ...
    /**
      * Sets the value of the 'percental_speed_change' field.
      * Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required.
      * @param value The value of 'percental_speed_change'.
      * @return This builder.
      */
    public eu.datacron.synopses.maritime.critical_point.Builder setPercentalSpeedChange(double value) {
    ...
    /**
      * Checks whether the 'percental_speed_change' field has been set.
      * Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required.
      * @return True if the 'percental_speed_change' field has been set, false otherwise.
      */
    public boolean hasPercentalSpeedChange() {
      return fieldSetFlags()[12];
    }


    /**
      * Clears the value of the 'percental_speed_change' field.
      * Instantaneous percentage difference in speed (used for Change In Speed Start). A value of 0 means that the vessel was stopped. Default value is -1. Required.
      * @return This builder.
      */
    public eu.datacron.synopses.maritime.critical_point.Builder clearPercentalSpeedChange() {
    ...
    public critical_point build() {
      try {
        ...
        record.heading_diff = fieldSetFlags()[11] ? this.heading_diff : (java.lang.Double) defaultValue(fields()[11]);
        record.percental_speed_change = fieldSetFlags()[12] ? this.percental_speed_change : (java.lang.Double) defaultValue(fields()[12]);
        return record;
      } catch (Exception e) {
